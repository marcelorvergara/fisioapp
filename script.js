...
function LoadLogin(){
    ...
    var pBanner = document.createElement("p");
    pBanner.className = "message2";
    pBanner.id = "banner";
    pBanner.innerText = "Projeto Acadêmico - Infnet\nInterfaces com HTML e CSS e Javascript"
    divLoginForm.appendChild(pBanner);
